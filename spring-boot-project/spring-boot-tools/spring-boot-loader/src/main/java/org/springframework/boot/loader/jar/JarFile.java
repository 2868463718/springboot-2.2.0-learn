...
public class JarFile extends java.util.jar.JarFile {
	...
	public static void registerUrlProtocolHandler() {
		String handlers = System.getProperty(PROTOCOL_HANDLER, "");//获取 java.protocol.handler.pkgs 系统属性，如果没有就设置为 “”
		System.setProperty(PROTOCOL_HANDLER,//判断 系统属性java.protocol.handler.pkgs 是否为 “”，如果是就设置该属性值为 org.springframework.boot.loader，
	 ...
	 */
	private static void resetCachedUrlHandlers() {//重置URLStreamHandlerFactory以防万一已经使用了实现jar协议的URLStreamHandlerFactory
		try {
